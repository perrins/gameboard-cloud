...
var _ = require('underscore-node');
    ...
    describe ("#/rest/categories", function() {

        it("Access List of Categories", function(done) {
            // Invoke the Promise for the Call
            ip.invoke("/categories/1","get",null).then(function (data) {
        ...
        it("Check we have more than one Category", function(done) {
            // Invoke the Promise for the Call
            ip.invoke("/categories/1","get",null).then(function (data) {
                if(data.response.statusCode == 404) {
                    throw data;
